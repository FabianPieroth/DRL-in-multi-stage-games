...
def run_sequential_sales_interdependent_experiment():
    environment = "sequential_auction"
    ...
    options = product(num_rounds_to_play_options, algorithm_options, settings)

    for option in options:
        num_rounds_to_play, algorithm, setting = option
